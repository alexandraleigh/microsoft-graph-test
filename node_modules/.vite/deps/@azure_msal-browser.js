...
var CredentialEntity = function() {
  ...
  CredentialEntity2._initRegex = function() {
    var separator = Separators.CACHE_KEY_SEPARATOR;
    CredentialEntity2.credentialRegexMap = /* @__PURE__ */ new Map();
    for (var _i = 0, _a = Object.keys(CredentialType); _i < _a.length; _i++) {
      var credKey = _a[_i];
      var credVal = CredentialType[credKey].toLowerCase();
      try {
        CredentialEntity2.credentialRegexMap.set(CredentialType[credKey], new RegExp("(?<=" + separator + CredentialEntity2.credentialDomainRegex + ")" + separator + credVal + separator));
      } catch (err) {
        CredentialEntity2.credentialRegexMap.set(CredentialType[credKey], new RegExp("" + separator + CredentialEntity2.credentialDomainRegex + separator + credVal + separator));
      }
    }
  ...
  CredentialEntity2.credentialDomainRegex = "(https?:\\/\\/)?((([\\w-]+\\.)*([\\w-]{1,63})(\\.(\\w{2,63})))|(localhost))(\\:[0-9]{4,5})?";
...
var PerformanceClient = function() {
  function PerformanceClient2(clientId, authority, logger, libraryName, libraryVersion, applicationTelemetry) {
    ...
    this.staticFieldsByCorrelationId = /* @__PURE__ */ new Map();
    ...
    this.countersByCorrelationId = /* @__PURE__ */ new Map();
  }
  ...
  PerformanceClient2.prototype.addQueueMeasurement = function(eventName, correlationId, queueTime) {
    if (!correlationId) {
    ...
    var queueMeasurement = { eventName, queueTime };
  ...
  PerformanceClient2.prototype.increment = function(counters, correlationId) {
    ...
    if (!existing) {
      ...
      this.countersByCorrelationId.set(correlationId, __assign2({}, counters));
      return;
    }
  ...
  PerformanceClient2.prototype.flushMeasurements = function(measureName, correlationId) {
    ...
    if (eventsForCorrelationId) {
      ...
      if (topLevelEvents.length > 0) {
        ...
        var finalEvent = __assign2(__assign2(__assign2(__assign2({}, eventToEmit), staticFields), counters), { queuedTimeMs: totalQueueTime, queuedCount: totalQueueCount, incompleteSubsCount: incompleteSubsCount_1 });
...
var BrowserPerformanceClient = function(_super) {
  ...
  BrowserPerformanceClient2.prototype.setPreQueueTime = function(eventName, correlationId) {
    ...
    if (preQueueTimesByEvents) {
      ...
      var preQueueTimes = /* @__PURE__ */ new Map();
      preQueueTimes.set(eventName, window.performance.now());
      this.preQueueTimeByCorrelationId.set(correlationId, preQueueTimes);
    }
  };
  BrowserPerformanceClient2.prototype.addQueueMeasurement = function(eventName, correlationId) {
    if (!this.supportsBrowserPerformanceNow()) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_b) {
        ...
        return [2, result.then(function(response) {
          ...
          (_b2 = _this.ssoSilentMeasurement) === null || _b2 === void 0 ? void 0 : _b2.flushMeasurement();
          throw e;
        }).finally(function() {
